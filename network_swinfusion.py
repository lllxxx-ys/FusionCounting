...
class Decoder_net(nn.Module):
    def __init__(self):
        ...
        self.downsample=nn.Sequential(
            nn.Conv2d(120,256,3,padding=1,stride=2),
...
class SwinFusion(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 embed_dim=96, Ex_depths=[3, 3], Fusion_depths=[2, 2, 2], Re_depths=[3,3],
                 Ex_num_heads=[3, 3], Fusion_num_heads=[6, 6, 6], Re_num_heads=[3, 3],
        ...
        self.patch_embed = PatchEmbed(
            ...
            norm_layer=norm_layer if self.patch_norm else None)#liu
        ...
        self.pos_drop = nn.Dropout(p=drop_rate)#liu
        ...
        self.norm_Re = norm_layer(self.num_features)#liu
        ...
        self.conv_last1 = nn.Conv2d(embed_dim, embed_dim_temp, 3, 1, 1)#liu
        self.conv_last2 = nn.Conv2d(embed_dim_temp, int(embed_dim_temp/2), 3, 1, 1)#liu
        self.conv_last3 = nn.Conv2d(int(embed_dim_temp/2), num_out_ch, 3, 1, 1)#liu
...
if __name__ == '__main__':
    ...
    model = SwinFusion(window_size=window_size,embed_dim=60)
    # print(model)
    # print(height, width, model.flops() / 1e9)
    #
    x = torch.randn((3, 60, 256, 256))
    z = model(x)
    print(z.shape)
